...
| copper_gold_63d_return | Copper / Gold 3-month return | model feature | Derived from Yahoo HG=F copper / GC=F gold | daily | same-day daily market observation | Y |  |  |
| copper_gold_ratio_level | Copper / Gold ratio | model feature | Derived from Yahoo HG=F copper / GC=F gold | daily | same-day daily market observation | Y | Y |  |
...
| eem_63d_return | EM equity 3-month return | model feature | Yahoo EEM (iShares MSCI EM) | daily | same-day daily market observation | Y | Y |  |
| efa_63d_return | DM ex-US equity 3-month return | model feature | Yahoo EFA (iShares MSCI EAFE) | daily | same-day daily market observation | Y |  |  |
...
| sector_rotation_63d_change | Sector rotation 3-month change | model feature | Derived from Yahoo XLU / XLY ETFs | daily | same-day daily market observation | Y |  |  |
| sector_rotation_xlu_xly | Sector rotation XLU/XLY ratio | model feature | Derived from Yahoo XLU / XLY ETFs | daily | same-day daily market observation | Y | Y |  |
...
| vix_term_structure | VIX / VIX3M term structure | model feature | FRED VIXCLS | daily | same-day daily market observation | Y | Y |  |
| vix_term_structure_21d_change | VIX term structure 1-month change | model feature | FRED VIXCLS | daily | same-day daily market observation | Y |  |  |
