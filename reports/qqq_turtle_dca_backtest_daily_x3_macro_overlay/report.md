...
- Tactical entry ramp phase days: `252`; `0` means immediate max leverage
- Tactical RVOL scan thresholds: `0, 2`; `0` means no RVOL confirmation
- Tactical macro entry modes: `none, wti_falling_yoy, wti_falling_or_10y_falling, wti_falling_and_10y_not_rising, avoid_wti_10y_stress, rates_easing_curve_steepening, dxy_rising_yoy`; macro values are shifted one trading day
