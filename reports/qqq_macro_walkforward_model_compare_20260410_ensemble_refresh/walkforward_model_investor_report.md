...
| walkforward_logistic_riskon_2x_prob_regime_dca | $128,950 | 20.2% | 20.3% | -46.8% |
| walkforward_logistic_riskon_3x_prob_regime_dca | $128,811 | 20.2% | 20.6% | -62.8% |
...
| walkforward_ensemble_majority_riskon_2x_prob_regime_dca | $100,307 | 17.2% | 17.2% | -46.8% |
| walkforward_gmm_riskon_3x_keep_long_riskoff_reserve_dca | $91,738 | 16.2% | 15.7% | -65.5% |
| walkforward_ensemble_majority_riskon_3x_prob_regime_dca | $79,772 | 14.5% | 14.5% | -69.6% |
...
- The current logistic 3x setting (`risk_off=0.45`, `jump_in=0.55`) finished at `$128,811` with `-62.8%` max drawdown.
- The best nearby 3x threshold in the local grid finished at `$142,932` with `-62.8%` max drawdown.
