...
try:
    ...
    # Headless environment with limited thread resources (e.g. Docker Toolbox).
    # Plotting functions will be no-ops; signal generation is unaffected.
    plt = None   # type: ignore[assignment]
    mtick = None  # type: ignore[assignment]
import numpy as np
import pandas as pd
